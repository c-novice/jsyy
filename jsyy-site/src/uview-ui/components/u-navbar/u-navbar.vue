      ...
      <view :style="[navbarInnerStyle]" class="u-navbar-inner">
        <view v-if="isBack" class="u-back-wrap" @tap="goBack">
          <view class="u-icon-wrap">
            <u-icon :color="backIconColor" :name="backIconName" :size="backIconSize"></u-icon>
          </view>
          <view v-if="backText" :style="[backTextStyle]" class="u-icon-wrap u-back-text u-line-1">{{ backText }}</view>
        </view>
        <view v-if="title" :style="[titleStyle]" class="u-navbar-content-title">
          <view
              :style="{
							color: titleColor,
