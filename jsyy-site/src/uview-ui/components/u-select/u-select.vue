    ...
    <u-popup v-model="value" :maskCloseAble="maskCloseAble" :popup="false" :safeAreaInsetBottom="safeAreaInsetBottom" :z-index="uZIndex"
      ...
      <view class="u-select">
        ...
        <view class="u-select__body">
          <picker-view :value="defaultSelector" class="u-select__body__picker-view" @change="columnChange"
                       @pickend="pickend" @pickstart="pickstart">
            <picker-view-column v-for="(item, index) in columnData" :key="index">
              <view v-for="(item1, index1) in item" :key="index1" class="u-select__body__picker-view__item">
