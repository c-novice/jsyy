<template>
  <view :style="[wrapStyle, backgroundStyle]" class="u-image" @tap="onClick">
    <image
        v-if="!isError"
        :lazy-load="lazyLoad"
        :mode="mode"
    ...
    >
      ...
      <u-icon v-else :height="height" :name="loadingIcon" :width="width"></u-icon>
    </view>
    <view
    ...
    >
      ...
      <u-icon v-else :height="height" :name="errorIcon" :width="width"></u-icon>
    </view>
  </view>
</template>
