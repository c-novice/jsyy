<template>
  <view
      ...
      @tap="click"
  >
    <u-icon v-if="icon" :custom-style="iconStyle" :name="icon" :size="iconSize" class="u-cell__left-icon-wrap"></u-icon>
    ...
    >
      ...
      <view v-if="label || $slots.label" :style="[labelStyle]" class="u-cell__label">
        <block v-if="label !== ''">{{ label }}</block>
        <slot v-else name="label"></slot>
      </view>
    </view>

    <view :style="[valueStyle]" class="u-cell__value">
    ...
    <u-icon v-if="arrow" :style="[arrowStyle]" class="u-icon-wrap u-cell__right-icon-wrap" name="arrow-right"></u-icon>
  </view>
</template>
