<template>
  ...
  >
    ...
    <view class="u-input__right-icon u-flex">
      ...
      <view v-if="passwordIcon && type == 'password'" class="u-input__right-icon__clear u-input__right-icon__item">
        <u-icon :name="!showPassword ? 'eye' : 'eye-fill'" color="#c0c4cc" size="32"
                @click="showPassword = !showPassword"/>
      </view>
      <view v-if="type == 'select'" :class="{
				'u-input__right-icon--select--reverse': selectOpen
			}" class="u-input__right-icon--select u-input__right-icon__item">
        <u-icon color="#c0c4cc" name="arrow-down-fill" size="26"></u-icon>
      </view>
    </view>
  </view>
</template>
