<template>
  <view class="u-numberbox">
    <view :class="{ 'u-icon-disabled': disabled || inputVal <= min }" :style="{
				background: bgColor,
      ...
      <u-icon :size="size" name="minus"></u-icon>
    </view>
    <input v-model="inputVal" :class="{ 'u-input-disabled': disabled }"
           :cursor-spacing="getCursorSpacing"
           :disabled="disabledInput || disabled" :style="{
				color: color,
				fontSize: size + 'rpx',
				background: bgColor,
				height: inputHeight + 'rpx',
				width: inputWidth + 'rpx'
			}" class="u-number-input" type="number"
           @blur="onBlur" @focus="onFocus"/>
    <view :class="{ 'u-icon-disabled': disabled || inputVal >= max }" :style="{
				background: bgColor,
				height: inputHeight + 'rpx',
				color: color
			}" class="u-icon-plus"
          ...
          @touchend.stop.prevent="clearTimer">
      <u-icon :size="size" name="plus"></u-icon>
    </view>
  </view>
</template>
