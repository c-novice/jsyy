<template>
  <view v-if="!disabled" class="u-upload">
    <view
    ...
    >
      ...
      >
        <u-icon :color="delColor" :name="delIcon" class="u-icon" size="20"></u-icon>
      </view>
      <u-line-progress
    ...
    <slot :file="lists" name="file"></slot>
    <view v-if="maxCount > lists.length" style="display: inline-block;" @tap="selectFile">
      ...
      <view
          ...
          hover-stay-time="150"
      >
        <u-icon class="u-add-btn" name="plus" size="40"></u-icon>
