<template>
  <view class="uqrcode">
    <view v-if="options.mode === 'view'" :style="{
      'width': `${options.size}px`,
      'height': `${options.size}px`,
      'padding': `${options.margin}px`,
      'background-color': options.backgroundColor
      }" class="uqrcode-view">
      <view v-for="(row, rowIndex) in modules.length" :key="rowIndex" class="uqrcode-view-row">
        <view v-for="(col, colIndex) in modules.length" :key="colIndex" :style="{
        	'width': `${colSize}px`,
        	'height': `${colSize}px`,
    ...
    <canvas v-else-if="options.mode === 'canvas'" :id="options.canvasId" :canvas-id="options.canvasId"
            :style="{'width': `${options.size}px`, 'height': `${options.size}px`}" class="uqrcode-canvas"/>
  </view>
</template>

<script>
import uqrcode from './uqrcode/common/uqrcode'
