<template>
  <view :style="{
		margin: margin,
	}" class="u-search" @tap="clickHandler">
    <view
        :style="{
    ...
    >
      <view class="u-icon-wrap">
        <u-icon :color="searchIconColor ? searchIconColor : color" :name="searchIcon" :size="30"
                class="u-clear-icon"></u-icon>
      </view>
      <input
          :disabled="disabled"
          :focus="focus"
          ...
          @input="inputChange"
      />
      <view v-if="keyword && clearabled && focused" class="u-close-wrap" @tap="clear">
        <u-icon class="u-clear-icon" color="#c0c4cc" name="close-circle-fill" size="34"></u-icon>
      </view>
    </view>
    <view :class="[showActionBtn || show ? 'u-action-active' : '']" :style="[actionStyle]"
          class="u-action"
